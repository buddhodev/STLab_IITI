            ...
            <div class="p-6 sm:p-8 min-h-[350px]">
                            ...
                            <div class="flex flex-col sm:flex-row gap-5 items-start">
                                ...
                                <div class="space-y-3 flex-1 font-sans">
                                    ...
                                    <div class="p-4 bg-white/70 border border-st-orange/15 rounded-xl text-xs text-slate-700 leading-relaxed font-light">
                                        This stellar accolade honors his decades of path-breaking research in bioprocess modeling, sustainable technology development, and life-cycle assessments (LCA). It places STLab and IIT Indore at the forefront of global scientific authority, testifying to the rigorous excellence maintained in our laboratory across food-energy-water nexus studies and Indian Knowledge Systems.
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="pane-publications" class="tab-pane hidden space-y-6 animate-tabFadeIn">
                    ...
                    $other_publications = [
                        ...
                        ["year" => 2021, "citation" => "Murthy, G. S., Gnansounou, E., Khanal, S. K., Pandey, A. (2021). Biomass, biofuels, biochemicals: green-economy: systems analysis for sustainability. Elsevier."],
                        ...
                        ["year" => 2021, "citation" => "Proctor, K., Murthy, G., Higgins, C. (2021). A Site-Level Integrated Analysis of Agrivoltaic Systems. AGU Fall Meeting Abstracts 2021."],
                        ...
                        ["year" => 2020, "citation" => "Proctor, K., Murthy, G., Higgins, C. W. (2020). Measuring Tomato production and Water Productivity in Agrivoltaic Systems. AGU Fall Meeting 2020."],
                        ["year" => 2020, "citation" => "Proctor, K. W., Murthy, G., Higgins, C. W. (2020). Potential of Agrivoltaic Systems to Increase US Food, Energy, and Water Security. AGU Fall Meeting Abstracts 2020."],
                        ...
                        ["year" => 2019, "citation" => "Babbar-Sebens, M., Rivera, S. J., Giles, N. A., Tilt, J., Reimer, J., Murthy, G., ... (2019). InterACTWEL Science Gateway for Adaptation Planning in Food-Energy-Water Sectors of Local Communities. AGU Fall Meeting Abstracts."],
                        ...
                        ["year" => 2018, "citation" => "Rivera, S. J., Giles, N. A., Babbar-Sebens, M., Tabatabai, H., Reimer, J., Murthy, G., ... (2018). A Secure Decision Support System for Coordination of Adaptation Planning Among FEW Actors. AGU Fall Meeting Abstracts."],
                    ...
                    ?>
                    <div class="space-y-1.5">
                        <h3 class="text-lg font-bold text-slate-805 uppercase">Publications & Intellectual Property</h3>
                    ...
                    <div class="flex flex-wrap gap-2 py-2 border-b border-slate-100">
                        <a href="#sec-dissertations" class="px-3 py-1.5 rounded bg-slate-100 hover:bg-slate-250 text-[#0d56a6] text-xs font-bold font-sans transition-all duration-200">
                            🎓 Graduate Dissertations (<?= count($dissertations) ?>)
                        </a>
                        <a href="#sec-patents" class="px-3 py-1.5 rounded bg-slate-100 hover:bg-slate-250 text-[#0d56a6] text-xs font-bold font-sans transition-all duration-200">
                            💡 Patents & IP (<?= count($patents) ?>)
                        </a>
                        <a href="#sec-papers" class="px-3 py-1.5 rounded bg-slate-100 hover:bg-slate-250 text-[#0d56a6] text-xs font-bold font-sans transition-all duration-200">
                            📄 Journal Papers (<?= count($other_publications) ?>)
                        </a>
                    </div>
                    ...
                    <div class="space-y-6 pt-1">
                        ...
                        <!-- GS PAPERS -->
                        <div id="sec-papers" class="space-y-3 pt-2">
                            <h4 class="text-xs font-bold text-slate-400 uppercase tracking-widest font-mono border-l-2 border-st-green pl-2">Publications & Other Papers</h4>
                            <div class="space-y-2">
                                <?php foreach ($other_publications as $pub): ?>
                                    <div class="p-3.5 rounded-xl border border-slate-200 card-3d-bevel flex gap-3 items-start bg-slate-50/50 hover:bg-white duration-200 transition-all">
                                        ...
                                        <div class="space-y-1.5 flex-1">
                                            <p class="text-[11.5px] text-slate-700 leading-relaxed font-sans">
                                                <?= $pub['citation'] ?>
                                            </p>
                                            <?php if (isset($pub['doi']) || isset($pub['link'])): ?>
                                                <div class="flex flex-wrap gap-2 pt-1 items-center">
                                                    <?php if (isset($pub['doi'])): ?>
                                                        <span class="text-[10px] bg-slate-100 border border-slate-200 rounded px-1.5 py-0.5 font-mono text-slate-500">
                                                            DOI: <?= htmlspecialchars($pub['doi']) ?>
                                                        </span>
                                                    <?php endif; ?>
                                                    <?php if (isset($pub['link'])): ?>
                                                        <a
                                                            href="<?= htmlspecialchars($pub['link']) ?>"
                                                            target="_blank"
                                                            rel="noreferrer"
                                                            referrerpolicy="no-referrer"
                                                            class="inline-flex items-center gap-1 text-[10.5px] font-bold text-st-blue hover:text-st-orange bg-st-blue/5 border border-st-blue/10 hover:border-st-orange/20 rounded px-2 py-0.5 transition-all"
                                                        >
                        ...
                        <div class="bg-white border border-slate-200 hover:border-st-green/30 rounded-xl p-5 hover:shadow-md transition-all duration-300 card-3d-bevel">
                            <div class="space-y-3">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        <h4 class="text-sm font-extrabold text-[#0d56a6] uppercase tracking-wide font-sans">5. Bioprocess Engineering and Technology (BSE 624)</h4>
                    ...
                    <div class="bg-slate-50 border border-slate-205 rounded-2xl p-6 sm:p-8 space-y-6 shadow-xs">
                        ...
                        <div class="flex flex-col lg:flex-row gap-4 justify-between items-stretch lg:items-center">
                            ...
                            <div class="flex flex-wrap gap-1.5 bg-slate-100 p-1 rounded-xl border border-slate-200/80 self-start">
                                <button onclick="filterPiTalks('all')" id="talk-btn-all" class="talk-filter-btn px-3 py-1.5 text-xs font-bold rounded-lg transition-all cursor-pointer bg-st-orange text-white shadow-xs">
                                    All Talks (30)
                                </button>
                                <button onclick="filterPiTalks('invited')" id="talk-btn-invited" class="talk-filter-btn px-3 py-1.5 text-xs font-bold rounded-lg transition-all cursor-pointer text-slate-600 hover:bg-slate-200 hover:text-slate-900">
                                    Invited Lectures (24)
                                </button>
    ...
    <script>
        ...
        function applyTalksFilter() {
            ...
            cards.forEach(card => {
                ...
                const matchesFilter = (currentTalkFilter === 'all' || category === currentTalkFilter);
